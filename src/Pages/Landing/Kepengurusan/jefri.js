      ...
      <div class="w3-col w3-light-grey l3 m4 s4 w3-margin-bottom w3-round-large">
          <div class="w3-card-4 w3-tooltip">
              ...
              <div class="w3-container">
                  <p style={{fontSize:"12px"}}><b>Jefri Abdurrozak Ismail</b></p>
                  <p style={{fontSize:"11px"}} class="w3-text">NPM : 18081010059</p>
                  <p style={{fontSize:"11px"}} class="w3-opacity">Div Perlengkapan</p>
