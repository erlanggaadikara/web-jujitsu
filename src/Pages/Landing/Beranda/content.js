    ...
    comp1 = () => {
        ...
        <div class="mySlides w3-animate-opacity">
            <img class="w3-image" src="/w3images/app.jpg" alt="Image 1" style="min-width:500px" width="1500" height="1000">
                ...
                <h1 class="w3-xlarge w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">Take photos with our app</h1>
                <hr class="w3-opacity w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
                <p class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">Super simple installment: free of charge</p>
