...
export default function alifio(){
    return(
      <div class="w3-col w3-light-grey l3 m4 s4 w3-margin-bottom w3-round-large">
          <div class="w3-card-4 w3-tooltip">
              ...
              <div class="w3-container">
                  <p style={{fontSize:"12px"}}><b>Alifio Ananda Shatria</b></p>
                  <p class="w3-text" style={{fontSize:"11px"}}>NPM : 18011010060</p>
                  <p class="w3-opacity" style={{fontSize:"11px"}}>Div Humas</p>
