...
export default function adelya(){
    return(
      <div class="w3-col w3-light-grey l3 m4 s4 w3-margin-bottom w3-round-large">
          <div class="w3-card-4 w3-tooltip">
              ...
              <div class="w3-container" style={{fontSize:"12px"}}>
                  <p style={{fontSize:"12px"}}><b>Adelya Eka Cahyono Putri</b></p>
                  <p class="w3-text" style={{fontSize:"11px"}}>NPM : 19013010062</p>
                  <p class="w3-opacity" style={{fontSize:"11px"}}>Div Pengembangan atlet</p>
